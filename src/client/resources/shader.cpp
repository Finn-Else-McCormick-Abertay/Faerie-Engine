...
#include <vector>
template<>
std::string ShaderRegistry::NormalisePath(const std::string& vert, const std::string& frag) {
    return "v_" + vert + ":f_" + frag;
}

template<>
Shader ShaderRegistry::Load(const std::string& vert, const std::string& frag) {
